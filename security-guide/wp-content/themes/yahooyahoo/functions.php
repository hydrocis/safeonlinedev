...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
     ...
     //    wp_enqueue_script('modernizr'); // Enqueue it!
        ...
        wp_register_script('bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '1.0.0'); 
        wp_register_script('particles', get_template_directory_uri() . '/assets/js/particles.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_register_script('app', get_template_directory_uri() . '/assets/js/app.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_register_script('jQuery', get_template_directory_uri() . '/assets/js/jQuery.js', array('jquery'), '1.0.0');
        wp_register_script('magnific', get_template_directory_uri() . '/assets/js/magnific.js', array('jquery'), '1.0.0');
...
function html5blank_styles()
{
    ...
    wp_register_style('mainstyle', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0', 'all');
...
function scenario_taxonomy() {

    $labels = array(
        'name'                       => _x( 'Scenarios', 'Taxonomy General Name', 'text_domain' ),
        'singular_name'              => _x( 'Scenario', 'Taxonomy Singular Name', 'text_domain' ),
        'menu_name'                  => __( 'Scenarios', 'text_domain' ),
    ...
    register_taxonomy( 'scenario', array( 'post' ), $args );

}
add_action( 'init', 'scenario_taxonomy', 0 );



// This will allow admins tie a single video suggestions to a particular post
if ( ! function_exists('custom_post_type_videos') ) {
...
function custom_post_type_videos() {
	...
	$args = array(
		...
		'description'           => __( 'Videos for safeonline.ng', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'author', 'thumbnail'),
		'taxonomies'            => array( 'category', ' post_tag', ' scenario' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
function so_get_related_posts( $post_id, $related_count, $args = array() ) {
...
/*------------------------------------*\
	Bulletproofing Wordpress
  Tips from https://zenwp.co/wordpress-security-tips/
\*------------------------------------*/
...
//Remove the Invalid Login Message
add_filter('login_errors',create_function('$a', "return null;"));

// Custom Scripting to Move JavaScript from the Head to the Footer

/*------------------------------------*\
    Moving the scripts to the footer.
